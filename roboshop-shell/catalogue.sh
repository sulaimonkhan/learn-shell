...
curl -o /tmp/catalogue.zip https://roboshop-artifacts.s3.amazonaws.com/$component.zip &>>$log_file
cd ${app_path}
...
cp /root/learn-shell/roboshop-shell/${componenet}.service /etc/systemd/system/$component.service &>>$log_file
